#!/usr/bin/env bash
# FP4 C4 indexer (sglang#37353) on DPA+TBO, c192, 3600 s.
# Byte-for-byte the settings of fp4_dptbo_c96.sh except CONC=192 (and the
...
# launcher, so they follow automatically (384 / 192 here).
set -u
...
export RESULT_DIR=/workspace/results/fp4-dptbo-c192
