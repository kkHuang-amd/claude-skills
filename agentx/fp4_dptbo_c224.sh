#!/usr/bin/env bash
# FP4 C4 indexer (sglang#37353) on DPA+TBO, c224, 3600 s.
# Byte-for-byte the settings of fp4_dptbo_c96.sh except CONC=224 (and the
...
# launcher, so they follow automatically (448 / 224 here).
set -u
...
export CONC=224 DURATION=3600 PORT=8888
...
export RESULT_DIR=/workspace/results/fp4-dptbo-c224
export RESULT_FILENAME="dsv4_fp4_sglang_tp8-pp1-dcp1-pcp1-ep1-dpatrue_disagg-false_spec-mtp_agentic_c224"
