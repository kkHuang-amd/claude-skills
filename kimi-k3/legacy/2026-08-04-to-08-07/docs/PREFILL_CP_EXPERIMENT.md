...
- Final artifacts:
  `/workspace/benchmark-results/kimi-k3-prefill-cp/20260804T043116Z-cp8-mem093-bs8-chunk8k`.
...
- Model: `/shared_nfs/huggingface_models/moonshotai/Kimi-K3`, 96 shards, approximately 1.6 TB
